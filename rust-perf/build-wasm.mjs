...
try {
    const rustOutput = "./target/wasm32-unknown-unknown/" + buildProfile + "/rust_perf.wasm";
    ...
    while (base64Data.length != 0) {
        ...
        fs.writeFileSync('./result.wasm' + fileNum + '.js', 'export default function(): string { return "' + chunk + '"; }');
        imports += 'import { default as wasm' + fileNum + ' } from \'./result.wasm' + fileNum + '.js\';\n';
